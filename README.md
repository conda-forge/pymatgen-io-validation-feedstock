About pymatgen-io-validation-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymatgen-io-validation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymatgen-io-validation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymatgen-io-validation
# for installing globally
pixi global install pymatgen-io-validation
```
...
It is possible to list all of the versions of `pymatgen-io-validation` available on your platform:
...
```
pixi search pymatgen-io-validation --channel conda-forge
```
